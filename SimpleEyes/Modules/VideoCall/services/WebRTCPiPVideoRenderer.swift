//
//  WebRTCPiPVideoRenderer.swift
//  SimpleEyes
//
//  WebRTC 画中画视频渲染器 - 自定义视频帧转换
//  将 RTCVideoFrame 转换为 CMSampleBuffer 用于画中画显示
//
...
/// WebRTC 画中画视频渲染器
///
/// 实现 RTCVideoRenderer 协议，将 WebRTC 视频帧转换为 AVFoundation 格式
///
/// ## 功能说明
/// - 接收 RTCVideoFrame（来自 WebRTC）
/// - 转换为 CVPixelBuffer（YUV420 格式）
/// - 创建 CMSampleBuffer（带时间戳）
/// - 输出到 AVSampleBufferDisplayLayer
///
/// ## 转换流程
/// 1. RTCVideoFrame -> I420Buffer
/// 2. I420Buffer -> CVPixelBuffer (NV12)
/// 3. CVPixelBuffer -> CMSampleBuffer
/// 4. 显示到 AVSampleBufferDisplayLayer
///
/// ## 性能优化
...
/// - 异步渲染避免阻塞
///
/// - Note: 仅用于画中画场景，普通渲染使用 RTCMTLVideoView
